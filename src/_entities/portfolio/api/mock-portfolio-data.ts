...
export const MOCK_SELECTABLE_PORTFOLIOS_DATA: SelectablePortfolio[] = [
  { id: "1", title: "Next.js 기반 실시간 협업 문서 에디터", categoryCode: "FULLSTACK_ENGINEER", thumbnailUrl: null, tags: ["Next.js", "TipTap", "WebSocket"] },
  { id: "2", title: "B2B SaaS 대시보드 UX 리디자인", categoryCode: "PRODUCT_DESIGNER", thumbnailUrl: null, tags: ["Figma", "Design System"] },
  { id: "3", title: "MAU 10만 앱 온보딩 리뉴얼", categoryCode: "PRODUCT_MANAGER", thumbnailUrl: null, tags: ["Product", "AB테스트"] },
]
